...
InfluenceAnalysis_update = function(x, random = FALSE, subplot.heights = c(30, 18),
    ...
    BaujatPlot = ggplot(bjt, aes(x = x, y = y)) + geom_point(aes(size = (1/se)), color = "blue", alpha = 1) +
    ...
    return.data = cbind(sortdat, cheungviechtdata[, 2:ncol(cheungviechtdata)], HetContrib = bjt$x, InfluenceEffectSize = bjt$y)
